...
const instance = ReduxKnifeManager.instance;
export default instance;

export const initialize = instance.initialize;
export const addKnife = instance.addKnife;
export const getKnife = instance.getKnife;
export const getKnives = instance.getKnife;
export const getRootReducer = instance.getRootReducer;
